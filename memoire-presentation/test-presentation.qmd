...
subtitle: "From Moving Sandpiles to Modern Machine Learning"
author: "Your Name"
...
format:
  revealjs:
    ...
    preview-links: auto
    footer: "Optimal Transport · A Gentle Introduction"
...
::: {.incremental}
- **The intuition** — what does it mean to "optimally transport" mass?
- **Monge (1781)** — the original problem, and why it can fail
- **Kantorovich (1942)** — the relaxation that fixed everything
- **Wasserstein distance** — a metric between probability distributions
- **Discrete OT** — it's just a linear program
- **Sinkhorn** — making OT fast with entropic regularization
- **Applications** — where OT shows up in ML today
:::
...
# The Intuition {background-color="#0f172a"}
